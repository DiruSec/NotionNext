...
const BLOG = {
  ...
  // DISQUS
  COMMENT_DISQUS_SHORTNAME: process.env.NEXT_PUBLIC_DISQUS_SHORTNAME || '',
  COMMENT_DISQUS_SITENAME: process.env.NEXT_PUBLIC_DISQUS_SITENAME || '',
  COMMENT_DISQUS_API: process.env.NEXT_PUBLIC_DISQUS_API || '',
  COMMENT_DISQUS_APIKEY: process.env.NEXT_PUBLIC_DISQUS_APIKEY || '',
  COMMENT_DISQUS_SHORTNAME: process.env.NEXT_PUBLIC_DISQUS_ADMIN || '',
  COMMENT_DISQUS_SHORTNAME: process.env.NEXT_PUBLIC_DISQUS_ADMINLABEL || '',
